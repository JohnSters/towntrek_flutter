                ...
                child: Row(
                  children: [
                    ...
                    _buildCountPill(
                      ...
                      '${town.propertyListingCount}',
                      TownSelectionConstants.propertiesLabel,
                      const Color(TownSelectionConstants.propertiesPillColor),
                    ),
                    const SizedBox(width: TownSelectionConstants.verticalSpacingSmall),
                    _buildCountPill(
                      context,
                      Icons.palette_rounded,
                      '${town.creativeSpaceCount}',
                      TownSelectionConstants.creativeSpacesLabel,
                      const Color(TownSelectionConstants.creativeSpacesPillColor),
                    ),
                    const SizedBox(width: TownSelectionConstants.verticalSpacingSmall),
                    _buildCountPill(
                      context,
                      Icons.construction_rounded,
                      '${town.equipmentRentalBusinessCount}',
                      TownSelectionConstants.equipmentRentalsLabel,
                      const Color(TownSelectionConstants.equipmentRentalsPillColor),
                    ),
                  ],
                ),
              ),
