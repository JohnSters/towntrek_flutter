...
class BusinessImageGallery extends StatelessWidget {
  ...
  Widget _buildSingleImage(BuildContext context, BusinessImageDto image) {
    return ClipRRect(
  ...
  Widget _buildImageCarousel(BuildContext context, List<BusinessImageDto> images) {
