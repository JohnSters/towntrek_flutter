...
class ParcelClaimTimelineDto {
  ...
  factory ParcelClaimTimelineDto.fromJson(Map<String, dynamic> json) {
    return ParcelClaimTimelineDto(
      ...
      claimedAt: JsonHelpers.utcDate(json['claimedAt']) ?? DateTime.now().toUtc(),
      pickedUpAt: JsonHelpers.utcDate(json['pickedUpAt']),
      deliveredAt: JsonHelpers.utcDate(json['deliveredAt']),
      confirmedAt: JsonHelpers.utcDate(json['confirmedAt']),
      cancelledAt: JsonHelpers.utcDate(json['cancelledAt']),
...
class ParcelSummaryDto {
  ...
  factory ParcelSummaryDto.fromJson(Map<String, dynamic> json) {
    return ParcelSummaryDto(
      ...
      createdAt: JsonHelpers.utcDate(json['createdAt']) ?? DateTime.now().toUtc(),
      expiresAt: JsonHelpers.utcDate(json['expiresAt']) ?? DateTime.now().toUtc(),
      requestedByDisplayName:
          json['requestedByDisplayName'] as String? ?? 'TownTrek member',
      routeSummary: json['routeSummary'] as String?,
      routeTravelDate: JsonHelpers.utcDate(json['routeTravelDate']),
